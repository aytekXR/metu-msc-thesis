\documentclass[chaparabic,is,ms,10pt,single]{metu} 
% Change this
...
\title{Developing A Transformer-Based Approach for Fusing Infrared and Visible Images for Improved Object Detection} % Change this
\turkishtitle{TÜRKÇE BAŞLIK} % Change this
...
%
% Dedication 
\dedication{To the memories of my beloved friends Murat Tekin and Ragip Enes Katran} % Change this
%
%
% Acknowledgements   
\acknowledgments{
...
\input{chapters/02BackgroundInformationRelatedWork.tex}
\input{chapters/03ProposedMethodology.tex}
\input{chapters/04ExperimentalResults.tex}
